...
function Gauge({ label, value, max = 3, color = "#22c55e" }) {
  ...
  const radius = 40; // matches arc path below
  ...
  return (
    <div className="gauge">
      ...
      <div className="gauge-center">
        ...
        <span className="gauge-max">/ {safeMax}</span>
      </div>
...
export default function InterviewReport() {
  ...
  // pull fields from new dummy shape (fallbacks so it doesn't crash)
  ...
  // Action items: either provided by backend later, or derived from weaknesses + summary
  ...
  // default overview details (you can later replace with real fields from backend)
  const overview = {
    ...
    <div className="report-wrap">
      ...
      {hasAnyContent && (
        <>
              ...
              <div>
                ...
                <div className="report-overview-list">
                  <div className="report-overview-row">
                    <span className="report-overview-label">
                      Interview Type
                    </span>
                  ...
                  <div className="report-overview-row">
                    <span className="report-overview-label">Role Fit</span>
                    <span className="report-overview-value">
                      {overview.roleFit}
                    </span>
                  </div>
                  ...
                  {jdSnippet && (
                    <div className="report-submeta">
                      <strong>JD snippet:</strong> {jdSnippet}
                    </div>
                  )}
                </div>
              </div>
          ...
          {/* SUMMARY CARD: interview_summary + strengths + weaknesses */}
          <section className="report-card">
            <div className="report-card-header">Summary (AI Overview)</div>
            <div className="report-summary-grid">
              <div>
                <div className="report-summary-block-title">
                  Overall Interview Summary
                </div>
                <div className="report-summary-block-body">
                  {interviewSummaryText || (
                    <span className="report-empty">
                      No interview summary generated.
                    </span>
                  )}
                </div>
              </div>
              <div>
                ...
                <div className="report-summary-block-body">
                  {strengthsText || (
                    <span className="report-empty">
                      No strengths captured for this session.
                    </span>
                  )}
                </div>
              </div>
              <div>
                ...
                <div className="report-summary-block-body">
                  {weaknessesText || (
                    <span className="report-empty">
                      No weaknesses captured for this session.
                    </span>
                  )}
                </div>
              </div>
          ...
          <section className="report-card">
            <div className="report-card-header">Interview Feedback</div>
              ...
              >
                <div className="feedback-header-left">
                  ...
                  <div className="feedback-title">
                    What I have done right this time?
                  </div>
                </div>
                <span
                  className={
            ...
            <div className="feedback-section">
              ...
              >
                <div className="feedback-header-left">
                  <div className="feedback-icon">📝</div>
                  <div className="feedback-title">
                    What are the specific action items to help me improve?
                  </div>
                </div>
                <span
                  className={
                    "feedback-chevron" +
                    (openSections.actions ? " open" : "")
                  }
                >
                  ▾
                </span>
              ...
              {openSections.actions && (
                <div className="feedback-body">
                  {actionBullets.length ? (
                    ...
                    <p className="report-empty">
                      No action items generated for this interview.
                    </p>
                  )}
                </div>
              )}
