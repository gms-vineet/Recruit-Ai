...
const RightSidePanel = ({ open, onClose, title = "Panel", activeKey, onSelect, children }) => {
  const isActive = (id) =>
    activeKey === id
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div
        className={`fixed top-0 right-0 h-full w-full sm:w-[380px] md:w-[420px]
      ...
      >
        ...
        <div className="p-4 overflow-y-auto h-[calc(100%-52px)] space-y-3">
          ...
          >
            ...
            <span className="text-sm font-medium">Job Description Generation</span>
          </button>
          ...
          >
            ...
            <span className="text-sm font-medium">Assign to Interviewr</span>
          </button>
